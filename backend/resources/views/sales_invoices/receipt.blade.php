...
<head>
    <meta charset="UTF-8">
    <title>وصل فاتورة رقم #{{ $salesInvoice->id }}</title>
    <style>
        @font-face {
        ...
        .receipt {
            width: 302px; /* عرض شائع للطابعات الحرارية 80mm */
...
<body>
    <div>
        ...
        <div class="receipt">
            <div class="header">
                <h4>{{ $salesInvoice->branch->name }}</h4>
                <p>{{ $salesInvoice->branch->address }}</p>
                <p>هاتف: {{ $salesInvoice->branch->phone }}</p>
            </div>
            ...
            <table class="details-table">
                ...
                <tr>
                    <td>التاريخ:</td>
                    <td>{{ \Carbon\Carbon::parse($salesInvoice->date)->format('Y-m-d H:i') }}</td>
                </tr>
                <tr>
                    <td>الكاشير:</td>
            ...
            <table class="summary-table">
                <tr>
                    <td>الإجمالي:</td>
                    <td class="grand-total">{{ number_format($salesInvoice->total, 2) }} جنيه</td>
                </tr>
                 <tr>
                    <td>طريقة الدفع:</td>
