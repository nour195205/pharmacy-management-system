        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">تنبيه: أدوية على وشك النفاذ (الكمية <= 10)</h5>
                </div>
                            ...
                            <tbody>
                                @forelse($lowStockMedicines as $stock)
                                    <tr>
                                        ...
                                        <td class="text-center"><span class="badge bg-danger">{{ rtrim(rtrim(number_format($stock->total_quantity, 2), '0'), '.') }}</span></td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="2" class="text-center text-muted py-3">لا توجد أدوية بكميات منخفضة.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                     <tr>
                                        <td colspan="3" class="text-center text-muted py-3">لا توجد أدوية ستنتهي صلاحيتها قريبًا.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
